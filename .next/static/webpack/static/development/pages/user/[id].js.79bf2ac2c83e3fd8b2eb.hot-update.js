...
function () {
  ...
  /*#__PURE__*/
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(_ref, state) {
    var query, usuario_a_load;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            usuario_a_load = state.data.filter(function (user) {
              return user.ndoc == numerodocumento;
            });
            return _context.abrupt("return", {
              user: usuario_a_load[0]
            });
...
//# sourceMappingURL=[id].js.79bf2ac2c83e3fd8b2eb.hot-update.js.map