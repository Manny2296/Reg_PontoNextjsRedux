...
function AddRegPonto() {
  ...
  switch (action.type) {
    case 'ADD_REG_PONTO':
      var stringify = _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_8___default()(action.payload);

      var aupdate = [stringify];

      if (action.payload != null) {
        if (action.payload.horasalida == '' || action.payload.horasalida == '--------') {
          console.log("entre a update ");

          var dataupd = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_7__["default"])(state.data);

          dataupd[dataupd.indexOf(usertmp)] = aupdate[0];
          nextState = {
            data: dataupd
          };
        } else {
          ...
          console.log("entrei al else" + _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_8___default()(nextState.data));
        }
      }
...
//# sourceMappingURL=_app.js.8ff7a5943036152a70a2.hot-update.js.map