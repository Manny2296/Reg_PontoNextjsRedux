  ...
  switch (action.type) {
    case 'ADD_REG_PONTO':
      ...
      if (action.payload != null) {
        if (action.payload.horasalida == '' || action.payload.horasalida == '--------') {} else {
          nextState = _objectSpread({}, state, {
            data: [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_6__["default"])(state.data), [action.payload])
          });
...
//# sourceMappingURL=_app.js.e580a7194c151722210f.hot-update.js.map