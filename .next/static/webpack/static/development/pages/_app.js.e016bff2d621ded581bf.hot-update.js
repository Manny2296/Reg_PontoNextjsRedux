...
function AddRegPonto() {
  ...
  switch (action.type) {
    case 'ADD_REG_PONTO':
      var stringify = _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_8___default()(action.payload, maskInfo);

      var maskInfo = function maskInfo(key, value) {
      ...
      if (action.payload != null) {
        ...
        console.log("entrei aqui" + _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_8___default()(nextState.data));
      }
...
//# sourceMappingURL=_app.js.e016bff2d621ded581bf.hot-update.js.map